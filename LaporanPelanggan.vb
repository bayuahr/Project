...
Public Class LaporanPelanggan
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim dv As New DataView(ds.Tables("Pelanggan"))
        If TextBox1.Text = "" Then
            dv.RowFilter = "Nama LIKE '%" & TextBox2.Text & "%' AND Alamat LIKE '%" & TextBox3.Text & "%'"
        Else
            dv.RowFilter = "ID_Pelanggan =" & TextBox1.Text & " AND Nama LIKE '%" & TextBox2.Text & "%' AND Alamat LIKE '%" & TextBox3.Text & "%'"
        End If
